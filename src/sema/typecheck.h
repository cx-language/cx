...
private:
    ...
    bool isImplicitlyConvertible(const Expr* expr, Type source, Type target, Type* convertedType, bool allowPointerToTemporary = false,
                                 bool* createImplicitCastExpr = nullptr) const;
