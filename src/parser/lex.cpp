...
static const llvm::StringMap<Token::Kind> keywords = {
    { "addressof", Token::Addressof }, { "as", Token::As },         { "break", Token::Break },
    { "case", Token::Case },           { "const", Token::Const },   { "continue", Token::Continue },
    { "default", Token::Default },     { "defer", Token::Defer },   { "deinit", Token::Deinit },
    { "else", Token::Else },           { "enum", Token::Enum },     { "extern", Token::Extern },
    { "false", Token::False },         { "for", Token::For },       { "if", Token::If },
    { "import", Token::Import },       { "in", Token::In },         { "init", Token::Init },
    { "interface", Token::Interface }, { "null", Token::Null },     { "private", Token::Private },
    { "return", Token::Return },       { "sizeof", Token::Sizeof }, { "struct", Token::Struct },
    { "switch", Token::Switch },       { "this", Token::This },     { "true", Token::True },
    { "undefined", Token::Undefined }, { "var", Token::Var },       { "while", Token::While },
    { "_", Token::Underscore },        { "#if", Token::HashIf },    { "#else", Token::HashElse },
