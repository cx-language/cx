...
private:
    ...
    InitDecl* parseInitDecl(TypeDecl& receiverTypeDecl, AccessLevel accessLevel);
    DeinitDecl* parseDeinitDecl(TypeDecl& receiverTypeDecl);
    ...
    InitDecl* createAutogeneratedInitializer(TypeDecl* typeDecl) const;
