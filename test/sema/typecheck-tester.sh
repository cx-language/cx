...
check_error unknown-function.delta "unknown identifier 'foo'"
...
check_error return-no-value-in-non-void-function.delta "expected return statement to return a value of type 'int'"
