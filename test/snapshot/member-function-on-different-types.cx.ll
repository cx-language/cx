...
define i32 @main() #0 !dbg !4 {
  ...
  call void @_EN4main3Foo4initE5int32(ptr %1, i32 1), !dbg !7
  call void @_EN4main3Foo7doStuffE(ptr %1), !dbg !8
  call void @_EN4main3Bar4initE5int32(ptr %2, i32 2), !dbg !9
  call void @_EN4main3Bar7doStuffE(ptr %2), !dbg !10
  ret i32 0
}

define void @_EN4main3Foo4initE5int32(ptr %this, i32 %i) #0 !dbg !11 {
...
define void @_EN4main3Bar4initE5int32(ptr %this, i32 %i) #0 !dbg !13 {
  %i1 = alloca i32, align 4
  store i32 %i, ptr %i1, align 4
...
!11 = distinct !DISubprogram(name: "init", linkageName: "_EN4main3Foo4initE5int32", scope: !3, file: !3, line: 3, type: !5, scopeLine: 3, spFlags: DISPFlagDefinition, unit: !2)
...
!13 = distinct !DISubprogram(name: "init", linkageName: "_EN4main3Bar4initE5int32", scope: !3, file: !3, line: 8, type: !5, scopeLine: 8, spFlags: DISPFlagDefinition, unit: !2)
