...
define i32 @main() {
  ...
  %7 = call i32 @_EN3std5SliceI3intE4sizeE(ptr %ref)
  store i32 %7, ptr %bb, align 4
  ret i32 0
}

define void @_EN4main3fooE5SliceI3intE(%"Slice<int>" %ints) {
  %ints1 = alloca %"Slice<int>", align 8
  %a = alloca i32, align 4
  %b = alloca i32, align 4
  %c = alloca %"Slice<int>", align 8
  store %"Slice<int>" %ints, ptr %ints1, align 8
  %1 = call ptr @_EN3std5SliceI3intEixE3int(ptr %ints1, i32 1)
  %.load = load i32, ptr %1, align 4
  store i32 %.load, ptr %a, align 4
  %2 = call i32 @_EN3std5SliceI3intE4sizeE(ptr %ints1)
...
define ptr @_EN3std5SliceI3intEixE3int(ptr %this, i32 %index) {
...
or.rhs:                                           ; preds = %0
  ...
  %2 = call i32 @_EN3std5SliceI3intE4sizeE(ptr %this)
...
if.then:                                          ; preds = %or.end
  ...
  call void @_EN3std5SliceI3intE16indexOutOfBoundsE6string3int(ptr %this, %string %__str.load, i32 %index.load3)
  br label %if.end
...
define void @_EN3std5SliceI3intE16indexOutOfBoundsE6string3int(ptr %this, %string %function, i32 %index) {
  ...
  call void @_EN3std6string4initEP4char3int(ptr %__str, ptr @1, i32 6)
