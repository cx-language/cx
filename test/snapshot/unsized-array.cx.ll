...
define i32 @main() #0 !dbg !4 {
  ...
  call void @_EN4main3fooE8ArrayRefI3intE(%"ArrayRef<int>" %3), !dbg !7
  ...
  %7 = call i32 @_EN3std8ArrayRefI3intE4sizeE(ptr %ref), !dbg !9
  store i32 %7, ptr %bb, align 4
  ret i32 0
}

define void @_EN4main3fooE8ArrayRefI3intE(%"ArrayRef<int>" %ints) #0 !dbg !10 {
  %ints1 = alloca %"ArrayRef<int>", align 8
  %a = alloca i32, align 4
  %b = alloca i32, align 4
  %c = alloca %"ArrayRef<int>", align 8
  store %"ArrayRef<int>" %ints, ptr %ints1, align 8
  %1 = call ptr @_EN3std8ArrayRefI3intEixE3int(ptr %ints1, i32 1), !dbg !11
  %.load = load i32, ptr %1, align 4
  store i32 %.load, ptr %a, align 4
  %2 = call i32 @_EN3std8ArrayRefI3intE4sizeE(ptr %ints1), !dbg !12
...
define i32 @_EN3std8ArrayRefI3intE4sizeE(ptr %this) #0 !dbg !14 {
  %size = getelementptr inbounds %"ArrayRef<int>", ptr %this, i32 0, i32 1
  %size.load = load i32, ptr %size, align 4
  ret i32 %size.load
}

define ptr @_EN3std8ArrayRefI3intEixE3int(ptr %this, i32 %index) #0 !dbg !16 {
...
or.rhs:                                           ; preds = %0
  ...
  %2 = call i32 @_EN3std8ArrayRefI3intE4sizeE(ptr %this), !dbg !17
...
if.then:                                          ; preds = %or.end
  ...
  call void @_EN3std8ArrayRefI3intE16indexOutOfBoundsE6string3int(ptr %this, %string %__str.load, i32 %index.load3), !dbg !19
  br label %if.end
...
define void @_EN3std8ArrayRefI3intE16indexOutOfBoundsE6string3int(ptr %this, %string %function, i32 %index) #0 !dbg !20 {
  ...
  call void @_EN3std6string4initEP4char3int(ptr %__str, ptr @1, i32 9), !dbg !21
  ...
  %2 = call i32 @_EN3std8ArrayRefI3intE4sizeE(ptr %this), !dbg !22
  store i32 %2, ptr %1, align 4
  %3 = call %never @_EN3std5abortI6string6string6string3int6string3intEVEP6stringP6stringP6stringP3intP6stringP3int(ptr %__str, ptr %function1, ptr %__str3, ptr %index2, ptr %__str4, ptr %1), !dbg !23
  ret void
}

declare %never @_EN3std5abortI6string6string6string3int6string3intEVEP6stringP6stringP6stringP3intP6stringP3int(ptr, ptr, ptr, ptr, ptr, ptr) #0
...
!10 = distinct !DISubprogram(name: "foo", linkageName: "_EN4main3fooE8ArrayRefI3intE", scope: !3, file: !3, line: 12, type: !5, scopeLine: 12, spFlags: DISPFlagDefinition, unit: !2)
...
!14 = distinct !DISubprogram(name: "size", linkageName: "_EN3std8ArrayRefI3intE4sizeE", scope: !15, file: !15, line: 31, type: !5, scopeLine: 31, spFlags: DISPFlagDefinition, unit: !2)
!15 = !DIFile(filename: "ArrayRef.cx")
!16 = distinct !DISubprogram(name: "[]", linkageName: "_EN3std8ArrayRefI3intEixE3int", scope: !15, file: !15, line: 42, type: !5, scopeLine: 42, spFlags: DISPFlagDefinition, unit: !2)
!17 = !DILocation(line: 43, column: 34, scope: !16)
!18 = !DILocation(line: 42, column: 14, scope: !16)
!19 = !DILocation(line: 43, column: 41, scope: !16)
!20 = distinct !DISubprogram(name: "indexOutOfBounds", linkageName: "_EN3std8ArrayRefI3intE16indexOutOfBoundsE6string3int", scope: !15, file: !15, line: 83, type: !5, scopeLine: 83, spFlags: DISPFlagDefinition, unit: !2)
!21 = !DILocation(line: 83, column: 18, scope: !20)
!22 = !DILocation(line: 84, column: 88, scope: !20)
