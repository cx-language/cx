...
define void @_CX1N4mainM4main1AIM4main1CE4initE4void0_(ptr %this) #0 !dbg !8 {
  %t = alloca %C, align 8
  call void @_CX1N4mainM4main1C4initE4void0_(ptr %t), !dbg !9
  ret void
}
...
!8 = distinct !DISubprogram(name: "init", linkageName: "_CX1N4mainM4main1AIM4main1CE4initE4void0_", scope: !3, file: !3, line: 9, type: !5, scopeLine: 9, spFlags: DISPFlagDefinition, unit: !2)
!9 = !DILocation(line: 10, column: 17, scope: !8)
!10 = distinct !DISubprogram(name: "init", linkageName: "_CX1N4mainM4main1C4initE4void0_", scope: !3, file: !3, line: 5, type: !5, scopeLine: 5, spFlags: DISPFlagDefinition, unit: !2)
