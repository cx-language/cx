...
define void @_EN4main3fooEOP3intP3int(ptr %a, ptr %b) #0 !dbg !4 {
...
!4 = distinct !DISubprogram(name: "foo", linkageName: "_EN4main3fooEOP3intP3int", scope: !3, file: !3, line: 3, type: !5, scopeLine: 3, spFlags: DISPFlagDefinition, unit: !2)
