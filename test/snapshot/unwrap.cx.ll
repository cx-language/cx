...
assert.fail:                                      ; preds = %0
  call void @_EN3std10assertFailEP4char(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @0, i32 0, i32 0))
  unreachable
...
assert.fail2:                                     ; preds = %assert.success
  call void @_EN3std10assertFailEP4char(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @1, i32 0, i32 0))
  unreachable
