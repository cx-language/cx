...
define i32 @main() #0 !dbg !4 {
  ...
  call void @_CX1N3stdM3std11ClosedRangeIM3std5int32E4initE4void2_M3std5int32M3std5int32(ptr %1, i32 0, i32 5), !dbg !7
  %3 = call %"ClosedRangeIterator<int32>" @_CX1N3stdM3std11ClosedRangeIM3std5int32E8iteratorEM3std19ClosedRangeIteratorIM3std5int32E0_(ptr %1), !dbg !8
  store %"ClosedRangeIterator<int32>" %3, ptr %__iterator, align 4
  br label %loop.condition

loop.condition:                                   ; preds = %loop.increment, %0
  %4 = call i1 @_CX1N3stdM3std19ClosedRangeIteratorIM3std5int32E8hasValueEM3std4bool0_(ptr %__iterator), !dbg !8
  br i1 %4, label %loop.body, label %loop.end

loop.body:                                        ; preds = %loop.condition
  %5 = call i32 @_CX1N3stdM3std19ClosedRangeIteratorIM3std5int32E5valueEM3std5int320_(ptr %__iterator), !dbg !8
...
loop.end:                                         ; preds = %loop.condition
  call void @_CX1N3stdM3std11ClosedRangeIM3std5int32E4initE4void2_M3std5int32M3std5int32(ptr %2, i32 0, i32 5), !dbg !9
  %6 = call %"ClosedRangeIterator<int32>" @_CX1N3stdM3std11ClosedRangeIM3std5int32E8iteratorEM3std19ClosedRangeIteratorIM3std5int32E0_(ptr %2), !dbg !10
...
loop.condition3:                                  ; preds = %loop.increment5, %loop.end
  %7 = call i1 @_CX1N3stdM3std19ClosedRangeIteratorIM3std5int32E8hasValueEM3std4bool0_(ptr %__iterator1), !dbg !10
  br i1 %7, label %loop.body4, label %loop.end6

loop.body4:                                       ; preds = %loop.condition3
  %8 = call i32 @_CX1N3stdM3std19ClosedRangeIteratorIM3std5int32E5valueEM3std5int320_(ptr %__iterator1), !dbg !10
  store i32 %8, ptr %i2, align 4
  br label %loop.increment5

loop.increment5:                                  ; preds = %loop.body4
  call void @_CX1N3stdM3std19ClosedRangeIteratorIM3std5int32E9incrementE4void0_(ptr %__iterator1), !dbg !10
  br label %loop.condition3
