...
define void @_EN4main1fE1S(%S %s) #0 !dbg !4 {
  ...
  call void @_EN4main1gER1S(ptr %s1), !dbg !7
  ret void
}

define void @_EN4main1gER1S(ptr %s) #0 !dbg !8 {
...
!8 = distinct !DISubprogram(name: "g", linkageName: "_EN4main1gER1S", scope: !3, file: !3, line: 9, type: !5, scopeLine: 9, spFlags: DISPFlagDefinition, unit: !2)
