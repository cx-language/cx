...
define void @_CX1N4main5identEM4main3Big1_M4main3Big(ptr sret(%Big) align 4 %sret.arg, ptr byval(%Big) align 4 %x) #0 !dbg !4 {
...
define void @_CX1N4main9makeOuterEM4main5Outer0_(ptr sret(%Outer) align 4 %sret.arg) #0 !dbg !7 {
  %1 = alloca %Outer, align 8
  %2 = alloca %Big, align 8
  call void @_CX1N4mainM4main3Big4initE4void5_M3std5int32M3std5int32M3std5int32M3std5int32M3std5int32(ptr %2, i32 1, i32 2, i32 3, i32 4, i32 5), !dbg !8
  %.load = alloca %Big, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %.load, ptr align 4 %2, i64 20, i1 false)
  call void @_CX1N4mainM4main5Outer4initE4void2_M4main3BigM3std5int32(ptr %1, ptr byval(%Big) align 4 %.load, i32 7), !dbg !9
...
define void @_CX1N4mainM4main3Big4initE4void5_M3std5int32M3std5int32M3std5int32M3std5int32M3std5int32(ptr %this, i32 %a, i32 %b, i32 %c, i32 %d, i32 %e) #0 !dbg !10 {
...
define void @_CX1N4mainM4main5Outer4initE4void2_M4main3BigM3std5int32(ptr %this, ptr byval(%Big) align 4 %item, i32 %tag) #0 !dbg !11 {
...
define void @_CX1N4main9identWideEM4main4Wide1_M4main4Wide(ptr sret(%Wide) align 16 %sret.arg, ptr byval(%Wide) align 16 %x) #0 !dbg !12 {
...
define i32 @main() #0 !dbg !13 {
  ...
  call void @_CX1N4mainM4main3Big4initE4void5_M3std5int32M3std5int32M3std5int32M3std5int32M3std5int32(ptr %b, i32 1, i32 2, i32 3, i32 4, i32 5), !dbg !14
  ...
  call void @_CX1N4main5identEM4main3Big1_M4main3Big(ptr sret(%Big) align 4 %sret.alloca, ptr byval(%Big) align 4 %b.load), !dbg !15
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @_CX1N4mainM4main4Wide4initE4void2_M3std6int128M3std6int128(ptr %w, i128 1, i128 2), !dbg !16
  ...
  call void @_CX1N4main9identWideEM4main4Wide1_M4main4Wide(ptr sret(%Wide) align 16 %sret.alloca2, ptr byval(%Wide) align 16 %w.load), !dbg !17
  ...
  call void @_CX1N4main9makeOuterEM4main5Outer0_(ptr sret(%Outer) align 4 %sret.alloca3), !dbg !18
...
!4 = distinct !DISubprogram(name: "ident", linkageName: "_CX1N4main5identEM4main3Big1_M4main3Big", scope: !3, file: !3, line: 21, type: !5, scopeLine: 21, spFlags: DISPFlagDefinition, unit: !2)
!5 = !DISubroutineType(types: !6)
!6 = !{}
!7 = distinct !DISubprogram(name: "makeOuter", linkageName: "_CX1N4main9makeOuterEM4main5Outer0_", scope: !3, file: !3, line: 25, type: !5, scopeLine: 25, spFlags: DISPFlagDefinition, unit: !2)
!8 = !DILocation(line: 26, column: 18, scope: !7)
!9 = !DILocation(line: 26, column: 12, scope: !7)
!10 = distinct !DISubprogram(name: "init", linkageName: "_CX1N4mainM4main3Big4initE4void5_M3std5int32M3std5int32M3std5int32M3std5int32M3std5int32", scope: !3, file: !3, line: 3, type: !5, scopeLine: 3, spFlags: DISPFlagDefinition, unit: !2)
!11 = distinct !DISubprogram(name: "init", linkageName: "_CX1N4mainM4main5Outer4initE4void2_M4main3BigM3std5int32", scope: !3, file: !3, line: 11, type: !5, scopeLine: 11, spFlags: DISPFlagDefinition, unit: !2)
!12 = distinct !DISubprogram(name: "identWide", linkageName: "_CX1N4main9identWideEM4main4Wide1_M4main4Wide", scope: !3, file: !3, line: 29, type: !5, scopeLine: 29, spFlags: DISPFlagDefinition, unit: !2)
...
!21 = distinct !DISubprogram(name: "init", linkageName: "_CX1N4mainM4main4Wide4initE4void2_M3std6int128M3std6int128", scope: !3, file: !3, line: 16, type: !5, scopeLine: 16, spFlags: DISPFlagDefinition, unit: !2)
