...
define void @_EN4main5identE3Big(ptr sret(%Big) align 4 %sret.arg, ptr byval(%Big) align 4 %x) {
...
define void @_EN4main9makeOuterE(ptr sret(%Outer) align 4 %sret.arg) {
  %1 = alloca %Outer, align 8
  %2 = alloca %Big, align 8
  call void @_EN4main3Big4initE3int3int3int3int3int(ptr %2, i32 1, i32 2, i32 3, i32 4, i32 5)
  %.load = alloca %Big, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %.load, ptr align 4 %2, i64 20, i1 false)
  call void @_EN4main5Outer4initE3Big3int(ptr %1, ptr byval(%Big) align 4 %.load, i32 7)
...
define void @_EN4main3Big4initE3int3int3int3int3int(ptr %this, i32 %a, i32 %b, i32 %c, i32 %d, i32 %e) {
...
define void @_EN4main5Outer4initE3Big3int(ptr %this, ptr byval(%Big) align 4 %item, i32 %tag) {
...
define void @_EN4main9identWideE4Wide(ptr sret(%Wide) align 16 %sret.arg, ptr byval(%Wide) align 16 %x) {
...
define i32 @main() {
  ...
  call void @_EN4main3Big4initE3int3int3int3int3int(ptr %b, i32 1, i32 2, i32 3, i32 4, i32 5)
  %b.load = alloca %Big, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %b.load, ptr align 4 %b, i64 20, i1 false)
  %sret.alloca = alloca %Big, align 8
  call void @_EN4main5identE3Big(ptr sret(%Big) align 4 %sret.alloca, ptr byval(%Big) align 4 %b.load)
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @_EN4main4Wide4initE6int1286int128(ptr %w, i128 1, i128 2)
  %w.load = alloca %Wide, align 16
  call void @llvm.memcpy.p0.p0.i64(ptr align 16 %w.load, ptr align 16 %w, i64 32, i1 false)
  %sret.alloca2 = alloca %Wide, align 16
  call void @_EN4main9identWideE4Wide(ptr sret(%Wide) align 16 %sret.alloca2, ptr byval(%Wide) align 16 %w.load)
  ...
  %sret.alloca3 = alloca %Outer, align 8
  call void @_EN4main9makeOuterE(ptr sret(%Outer) align 4 %sret.alloca3)
...
overflow.success:                                 ; preds = %if.end
  %sret.alloca6 = alloca %Outer, align 8
  call void @_EN4main9makeOuterE(ptr sret(%Outer) align 4 %sret.alloca6)
...
define void @_EN4main4Wide4initE6int1286int128(ptr %this, i128 %a, i128 %b) {
