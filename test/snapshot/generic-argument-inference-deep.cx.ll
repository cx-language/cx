...
define void @_EN4main1fEP1SI4boolEP1SI4boolE(ptr %c, ptr %d) #0 !dbg !9 {
  ...
  %1 = call i1 @_EN4maineqI4boolEE1SI4boolE1SI4boolE(%"S<bool>" %c.load.load, %"S<bool>" %d.load.load), !dbg !10
  ret void
}

define i1 @_EN4maineqI4boolEE1SI4boolE1SI4boolE(%"S<bool>" %a, %"S<bool>" %b) #0 !dbg !11 {
