...
define i32 @main() #0 !dbg !4 {
  ...
  call void @_EN3std7printlnI3intEE3int(i32 3), !dbg !7
  ret i32 0
}

define void @_EN3std7printlnI3intEE3int(i32 %value) #0 !dbg !8 {
  %value1 = alloca i32, align 4
  store i32 %value, ptr %value1, align 4
  %value.load = load i32, ptr %value1, align 4
  call void @_EN3std5printI3intEE3int(i32 %value.load), !dbg !10
...
!8 = distinct !DISubprogram(name: "println", linkageName: "_EN3std7printlnI3intEE3int", scope: !9, file: !9, line: 8, type: !5, scopeLine: 8, spFlags: DISPFlagDefinition, unit: !2)
