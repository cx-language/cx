...
define i32 @main() #0 !dbg !4 {
  ...
  call void @_EN4main3Foo4initE3int(ptr %foo, i32 42), !dbg !7
  call void @_EN4main3Bar4initE3int3int(ptr %bar, i32 -1, i32 42), !dbg !8
  ret i32 0
}
...
define void @_EN4main3Bar4initE3int3int(ptr %this, i32 %j, i32 %i) #0 !dbg !10 {
...
!9 = distinct !DISubprogram(name: "init", linkageName: "_EN4main3Foo4initE3int", scope: !3, file: !3, line: 3, type: !5, scopeLine: 3, spFlags: DISPFlagDefinition, unit: !2)
!10 = distinct !DISubprogram(name: "init", linkageName: "_EN4main3Bar4initE3int3int", scope: !3, file: !3, line: 7, type: !5, scopeLine: 7, spFlags: DISPFlagDefinition, unit: !2)
