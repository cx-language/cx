...
define i32 @main() {
  ...
  %p.load = load i32 (i32)*, i32 (i32)** %p, align 8
...
define void @_EN4main1X4initEF3int_3int(%X* %this, i32 (i32)* %p) {
  ...
  store i32 (i32)* %p, i32 (i32)** %p1, align 8
  ret void
}
...
define void @_EN4main1X1fE(%X* %this) {
  ...
  %1 = call i32 %p.load(i32 42)
  %p1 = getelementptr inbounds %X, %X* %this, i32 0, i32 0
  %p.load2 = load i32 (i32)*, i32 (i32)** %p1, align 8
  %2 = call i32 %p.load2(i32 42)
  %p3 = getelementptr inbounds %X, %X* %this, i32 0, i32 0
  %p.load4 = load i32 (i32)*, i32 (i32)** %p3, align 8
  store i32 (i32)* %p.load4, i32 (i32)** %p2, align 8
  %p2.load = load i32 (i32)*, i32 (i32)** %p2, align 8
