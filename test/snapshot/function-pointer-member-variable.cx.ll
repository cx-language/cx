...
define i32 @_EN4main3fooE5int32(i32 %a) #0 !dbg !4 {
...
define i32 @main() #0 !dbg !7 {
  %x = alloca %X, align 8
  call void @_EN4main1X4initEF5int32_5int32(ptr %x, ptr @_EN4main3fooE5int32), !dbg !8
...
define void @_EN4main1X4initEF5int32_5int32(ptr %this, ptr %p) #0 !dbg !11 {
...
!4 = distinct !DISubprogram(name: "foo", linkageName: "_EN4main3fooE5int32", scope: !3, file: !3, line: 14, type: !5, scopeLine: 14, spFlags: DISPFlagDefinition, unit: !2)
...
!11 = distinct !DISubprogram(name: "init", linkageName: "_EN4main1X4initEF5int32_5int32", scope: !3, file: !3, line: 3, type: !5, scopeLine: 3, spFlags: DISPFlagDefinition, unit: !2)
