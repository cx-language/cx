...
define %vec2 @_CX1N4maino2mlEM4main4vec22_M4main4vec2M4main4vec2(%vec2 %a, %vec2 %b) #0 !dbg !4 {
...
define i32 @main() #0 !dbg !10 {
  ...
  call void @_CX1N4mainM4main4vec24initE4void2_M3std5int32M3std5int32(ptr %v, i32 3, i32 2), !dbg !11
  call void @_CX1N4mainM4main4vec24initE4void2_M3std5int32M3std5int32(ptr %1, i32 2, i32 4), !dbg !12
  %.load = load %vec2, ptr %1, align 4
  %v.load = load %vec2, ptr %v, align 4
  %3 = call %vec2 @_CX1N4maino2mlEM4main4vec22_M4main4vec2M4main4vec2(%vec2 %.load, %vec2 %v.load), !dbg !13
  store %vec2 %3, ptr %v, align 4
  %v.load1 = load %vec2, ptr %v, align 4
  call void @_CX1N4mainM4main4vec24initE4void2_M3std5int32M3std5int32(ptr %2, i32 -1, i32 3), !dbg !14
  %.load2 = load %vec2, ptr %2, align 4
  %4 = call i1 @_CX1N4maino2eqEM3std4bool2_M4main4vec2M4main4vec2(%vec2 %v.load1, %vec2 %.load2), !dbg !15
...
!4 = distinct !DISubprogram(name: "*", linkageName: "_CX1N4maino2mlEM4main4vec22_M4main4vec2M4main4vec2", scope: !3, file: !3, line: 12, type: !5, scopeLine: 12, spFlags: DISPFlagDefinition, unit: !2)
!5 = !DISubroutineType(types: !6)
!6 = !{}
!7 = !DILocation(line: 12, column: 6, scope: !4)
!8 = !DILocation(line: 13, column: 12, scope: !4)
!9 = distinct !DISubprogram(name: "init", linkageName: "_CX1N4mainM4main4vec24initE4void2_M3std5int32M3std5int32", scope: !3, file: !3, line: 3, type: !5, scopeLine: 3, spFlags: DISPFlagDefinition, unit: !2)
