...
define i32 @main() #0 !dbg !4 {
  ...
  call void @_EN4main1fI3intEER3int(ptr %i), !dbg !7
  ret i32 0
}

define void @_EN4main1fI3intEER3int(ptr %p) #0 !dbg !8 {
...
!8 = distinct !DISubprogram(name: "f", linkageName: "_EN4main1fI3intEER3int", scope: !3, file: !3, line: 3, type: !5, scopeLine: 3, spFlags: DISPFlagDefinition, unit: !2)
