...
define i32 @main() #0 !dbg !4 {
  ...
  call void @_EN3std4ListI5int32E4initE8capacity5int32(ptr %i, i32 10), !dbg !7
  call void @_EN3std4ListI5int32E4initE(ptr %j), !dbg !8
  call void @_EN3std4ListI5int32E6deinitE(ptr %i), !dbg !9
  call void @_EN3std4ListI5int32E4initE(ptr %1), !dbg !10
  %.load = load %"List<int32>", ptr %1, align 8
  store %"List<int32>" %.load, ptr %i, align 8
  call void @_EN3std4ListI5int32E6deinitE(ptr %j), !dbg !9
  call void @_EN3std4ListI5int32E6deinitE(ptr %i), !dbg !9
  ret i32 0
}

define void @_EN3std4ListI5int32E4initE8capacity5int32(ptr %this, i32 %capacity) #0 !dbg !11 {
  %capacity1 = alloca i32, align 4
  store i32 %capacity, ptr %capacity1, align 4
  call void @_EN3std4ListI5int32E4initE(ptr %this), !dbg !13
  %capacity.load = load i32, ptr %capacity1, align 4
  call void @_EN3std4ListI5int32E7reserveE5int32(ptr %this, i32 %capacity.load), !dbg !14
  ret void
}

define void @_EN3std4ListI5int32E4initE(ptr %this) #0 !dbg !15 {
...
define void @_EN3std4ListI5int32E6deinitE(ptr %this) #0 !dbg !16 {
...
if.then:                                          ; preds = %0
  %2 = call %"ArrayIterator<int32>" @_EN3std4ListI5int32E8iteratorE(ptr %this), !dbg !17
...
loop.condition:                                   ; preds = %loop.increment, %if.then
  %3 = call i1 @_EN3std13ArrayIteratorI5int32E8hasValueE(ptr %__iterator), !dbg !17
  br i1 %3, label %loop.body, label %loop.end

loop.body:                                        ; preds = %loop.condition
  %4 = call ptr @_EN3std13ArrayIteratorI5int32E5valueE(ptr %__iterator), !dbg !17
  store ptr %4, ptr %element, align 8
  br label %loop.increment

loop.increment:                                   ; preds = %loop.body
  call void @_EN3std13ArrayIteratorI5int32E9incrementE(ptr %__iterator), !dbg !17
  br label %loop.condition

loop.end:                                         ; preds = %loop.condition
  %buffer = getelementptr inbounds %"List<int32>", ptr %this, i32 0, i32 0
  %buffer.load = load ptr, ptr %buffer, align 8
  call void @_EN3std10deallocateIAU_5int32EEAU_5int32(ptr %buffer.load), !dbg !18
  br label %if.end
}

define %"ArrayIterator<int32>" @_EN3std4ListI5int32E8iteratorE(ptr %this) #0 !dbg !19 {
  %1 = alloca %"ArrayIterator<int32>", align 8
  %2 = alloca %"Slice<int32>", align 8
  call void @_EN3std5SliceI5int32E4initER4ListI5int32E(ptr %2, ptr %this), !dbg !20
  %.load = load %"Slice<int32>", ptr %2, align 8
  call void @_EN3std13ArrayIteratorI5int32E4initE5SliceI5int32E(ptr %1, %"Slice<int32>" %.load), !dbg !21
  %.load1 = load %"ArrayIterator<int32>", ptr %1, align 8
  ret %"ArrayIterator<int32>" %.load1
}

define i1 @_EN3std13ArrayIteratorI5int32E8hasValueE(ptr %this) #0 !dbg !22 {
...
define ptr @_EN3std13ArrayIteratorI5int32E5valueE(ptr %this) #0 !dbg !24 {
  %current = getelementptr inbounds %"ArrayIterator<int32>", ptr %this, i32 0, i32 0
  %current.load = load ptr, ptr %current, align 8
  ret ptr %current.load
}

define void @_EN3std13ArrayIteratorI5int32E9incrementE(ptr %this) #0 !dbg !25 {
  %current = getelementptr inbounds %"ArrayIterator<int32>", ptr %this, i32 0, i32 0
  %current.load = load ptr, ptr %current, align 8
...
define void @_EN3std10deallocateIAU_5int32EEAU_5int32(ptr %allocation) #0 !dbg !26 {
...
define void @_EN3std4ListI5int32E7reserveE5int32(ptr %this, i32 %minimumCapacity) #0 !dbg !29 {
...
if.then:                                          ; preds = %0
  ...
  %3 = call ptr @_EN3std13allocateArrayI5int32EE5int32(i32 %minimumCapacity.load2), !dbg !30
  store ptr %3, ptr %newBuffer, align 8
  %size = getelementptr inbounds %"List<int32>", ptr %this, i32 0, i32 1
  %size.load = load i32, ptr %size, align 4
  call void @_EN3std5RangeI5int32E4initE5int325int32(ptr %1, i32 0, i32 %size.load), !dbg !31
  %4 = call %"RangeIterator<int32>" @_EN3std5RangeI5int32E8iteratorE(ptr %1), !dbg !32
...
loop.condition:                                   ; preds = %loop.increment, %if.then
  %5 = call i1 @_EN3std13RangeIteratorI5int32E8hasValueE(ptr %__iterator), !dbg !32
  br i1 %5, label %loop.body, label %loop.end

loop.body:                                        ; preds = %loop.condition
  %6 = call i32 @_EN3std13RangeIteratorI5int32E5valueE(ptr %__iterator), !dbg !32
...
loop.increment:                                   ; preds = %loop.body
  call void @_EN3std13RangeIteratorI5int32E9incrementE(ptr %__iterator), !dbg !32
  br label %loop.condition
...
if.then6:                                         ; preds = %loop.end
  ...
  call void @_EN3std10deallocateIAU_5int32EEAU_5int32(ptr %buffer.load8), !dbg !33
  br label %if.end10
...
define void @_EN3std5SliceI5int32E4initER4ListI5int32E(ptr %this, ptr %list) #0 !dbg !34 {
  ...
  %1 = call ptr @_EN3std4ListI5int32E4dataE(ptr %list.load), !dbg !36
  store ptr %1, ptr %data, align 8
  %size = getelementptr inbounds %"Slice<int32>", ptr %this, i32 0, i32 1
  %list.load2 = load ptr, ptr %list1, align 8
  %2 = call i32 @_EN3std4ListI5int32E4sizeE(ptr %list.load2), !dbg !37
  store i32 %2, ptr %size, align 4
  ret void
}

define void @_EN3std13ArrayIteratorI5int32E4initE5SliceI5int32E(ptr %this, %"Slice<int32>" %array) #0 !dbg !38 {
  %array1 = alloca %"Slice<int32>", align 8
  store %"Slice<int32>" %array, ptr %array1, align 8
  %current = getelementptr inbounds %"ArrayIterator<int32>", ptr %this, i32 0, i32 0
  %1 = call ptr @_EN3std5SliceI5int32E4dataE(ptr %array1), !dbg !39
  store ptr %1, ptr %current, align 8
  %end = getelementptr inbounds %"ArrayIterator<int32>", ptr %this, i32 0, i32 1
  %2 = call ptr @_EN3std5SliceI5int32E4dataE(ptr %array1), !dbg !40
  %3 = call i32 @_EN3std5SliceI5int32E4sizeE(ptr %array1), !dbg !41
...
define ptr @_EN3std13allocateArrayI5int32EE5int32(i32 %size) #0 !dbg !42 {
...
define ptr @_EN3std5SliceI5int32E4dataE(ptr %this) #0 !dbg !45 {
  %data = getelementptr inbounds %"Slice<int32>", ptr %this, i32 0, i32 0
  %data.load = load ptr, ptr %data, align 8
  ret ptr %data.load
}

define i32 @_EN3std5SliceI5int32E4sizeE(ptr %this) #0 !dbg !46 {
  %size = getelementptr inbounds %"Slice<int32>", ptr %this, i32 0, i32 1
  %size.load = load i32, ptr %size, align 4
  ret i32 %size.load
}

define ptr @_EN3std4ListI5int32E4dataE(ptr %this) #0 !dbg !47 {
  %buffer = getelementptr inbounds %"List<int32>", ptr %this, i32 0, i32 0
  %buffer.load = load ptr, ptr %buffer, align 8
  ret ptr %buffer.load
}

define i32 @_EN3std4ListI5int32E4sizeE(ptr %this) #0 !dbg !48 {
  %size = getelementptr inbounds %"List<int32>", ptr %this, i32 0, i32 1
  %size.load = load i32, ptr %size, align 4
  ret i32 %size.load
}
...
!11 = distinct !DISubprogram(name: "init", linkageName: "_EN3std4ListI5int32E4initE8capacity5int32", scope: !12, file: !12, line: 15, type: !5, scopeLine: 15, spFlags: DISPFlagDefinition, unit: !2)
!12 = !DIFile(filename: "List.cx")
!13 = !DILocation(line: 16, column: 9, scope: !11)
!14 = !DILocation(line: 17, column: 9, scope: !11)
!15 = distinct !DISubprogram(name: "init", linkageName: "_EN3std4ListI5int32E4initE", scope: !12, file: !12, line: 8, type: !5, scopeLine: 8, spFlags: DISPFlagDefinition, unit: !2)
!16 = distinct !DISubprogram(name: "deinit", linkageName: "_EN3std4ListI5int32E6deinitE", scope: !12, file: !12, line: 43, type: !5, scopeLine: 43, spFlags: DISPFlagDefinition, unit: !2)
!17 = !DILocation(line: 45, column: 13, scope: !16)
!18 = !DILocation(line: 48, column: 13, scope: !16)
!19 = distinct !DISubprogram(name: "iterator", linkageName: "_EN3std4ListI5int32E8iteratorE", scope: !12, file: !12, line: 227, type: !5, scopeLine: 227, spFlags: DISPFlagDefinition, unit: !2)
!20 = !DILocation(line: 229, column: 30, scope: !19)
!21 = !DILocation(line: 229, column: 16, scope: !19)
!22 = distinct !DISubprogram(name: "hasValue", linkageName: "_EN3std13ArrayIteratorI5int32E8hasValueE", scope: !23, file: !23, line: 13, type: !5, scopeLine: 13, spFlags: DISPFlagDefinition, unit: !2)
!23 = !DIFile(filename: "ArrayIterator.cx")
!24 = distinct !DISubprogram(name: "value", linkageName: "_EN3std13ArrayIteratorI5int32E5valueE", scope: !23, file: !23, line: 18, type: !5, scopeLine: 18, spFlags: DISPFlagDefinition, unit: !2)
!25 = distinct !DISubprogram(name: "increment", linkageName: "_EN3std13ArrayIteratorI5int32E9incrementE", scope: !23, file: !23, line: 23, type: !5, scopeLine: 23, spFlags: DISPFlagDefinition, unit: !2)
!26 = distinct !DISubprogram(name: "deallocate", linkageName: "_EN3std10deallocateIAU_5int32EEAU_5int32", scope: !27, file: !27, line: 52, type: !5, scopeLine: 52, spFlags: DISPFlagDefinition, unit: !2)
!27 = !DIFile(filename: "allocate.cx")
!28 = !DILocation(line: 53, column: 5, scope: !26)
!29 = distinct !DISubprogram(name: "reserve", linkageName: "_EN3std4ListI5int32E7reserveE5int32", scope: !12, file: !12, line: 141, type: !5, scopeLine: 141, spFlags: DISPFlagDefinition, unit: !2)
...
!34 = distinct !DISubprogram(name: "init", linkageName: "_EN3std5SliceI5int32E4initER4ListI5int32E", scope: !35, file: !35, line: 13, type: !5, scopeLine: 13, spFlags: DISPFlagDefinition, unit: !2)
!35 = !DIFile(filename: "Slice.cx")
!36 = !DILocation(line: 14, column: 21, scope: !34)
!37 = !DILocation(line: 15, column: 21, scope: !34)
!38 = distinct !DISubprogram(name: "init", linkageName: "_EN3std13ArrayIteratorI5int32E4initE5SliceI5int32E", scope: !23, file: !23, line: 7, type: !5, scopeLine: 7, spFlags: DISPFlagDefinition, unit: !2)
!39 = !DILocation(line: 8, column: 25, scope: !38)
!40 = !DILocation(line: 9, column: 22, scope: !38)
!41 = !DILocation(line: 9, column: 35, scope: !38)
!42 = distinct !DISubprogram(name: "allocateArray", linkageName: "_EN3std13allocateArrayI5int32EE5int32", scope: !27, file: !27, line: 35, type: !5, scopeLine: 35, spFlags: DISPFlagDefinition, unit: !2)
!43 = !DILocation(line: 35, column: 9, scope: !42)
!44 = !DILocation(line: 36, column: 26, scope: !42)
!45 = distinct !DISubprogram(name: "data", linkageName: "_EN3std5SliceI5int32E4dataE", scope: !35, file: !35, line: 55, type: !5, scopeLine: 55, spFlags: DISPFlagDefinition, unit: !2)
!46 = distinct !DISubprogram(name: "size", linkageName: "_EN3std5SliceI5int32E4sizeE", scope: !35, file: !35, line: 31, type: !5, scopeLine: 31, spFlags: DISPFlagDefinition, unit: !2)
!47 = distinct !DISubprogram(name: "data", linkageName: "_EN3std4ListI5int32E4dataE", scope: !12, file: !12, line: 117, type: !5, scopeLine: 117, spFlags: DISPFlagDefinition, unit: !2)
!48 = distinct !DISubprogram(name: "size", linkageName: "_EN3std4ListI5int32E4sizeE", scope: !12, file: !12, line: 53, type: !5, scopeLine: 53, spFlags: DISPFlagDefinition, unit: !2)
