...
define i32 @_EN4main1fE3int(i32 %a) #0 !dbg !4 {
...
define i32 @main() #0 !dbg !7 {
  call void @foo(ptr @_EN4main1fE3int), !dbg !8
  call void @bar(ptr @_EN4main1fE3int), !dbg !9
  call void @baz(ptr @_EN4main1fE3int), !dbg !10
  ret i32 0
}
...
!4 = distinct !DISubprogram(name: "f", linkageName: "_EN4main1fE3int", scope: !3, file: !3, line: 5, type: !5, scopeLine: 5, spFlags: DISPFlagDefinition, unit: !2)
