...
define i32 @main() #0 !dbg !4 {
  ...
  call void @_EN4main1S4initE3int(ptr %t, i32 1), !dbg !8
  ret i32 0
}
...
define void @_EN4main1S4initE3int(ptr %this, i32 %foo) #0 !dbg !10 {
...
!10 = distinct !DISubprogram(name: "init", linkageName: "_EN4main1S4initE3int", scope: !3, file: !3, line: 8, type: !5, scopeLine: 8, spFlags: DISPFlagDefinition, unit: !2)
