...
define i32 @main() #0 !dbg !4 {
  ...
  call void @_EN4main1XI3intE4initE(ptr %x), !dbg !7
  call void @_EN4main1XI3intE6deinitE(ptr %x), !dbg !8
  ret i32 0
}

define void @_EN4main1XI3intE4initE(ptr %this) #0 !dbg !9 {
  %y = getelementptr inbounds %"X<int>", ptr %this, i32 0, i32 0
  store ptr null, ptr %y, align 8
  ret void
}

define void @_EN4main1XI3intE6deinitE(ptr %this) #0 !dbg !10 {
...
!9 = distinct !DISubprogram(name: "init", linkageName: "_EN4main1XI3intE4initE", scope: !3, file: !3, line: 6, type: !5, scopeLine: 6, spFlags: DISPFlagDefinition, unit: !2)
!10 = distinct !DISubprogram(name: "deinit", linkageName: "_EN4main1XI3intE6deinitE", scope: !3, file: !3, line: 10, type: !5, scopeLine: 10, spFlags: DISPFlagDefinition, unit: !2)
