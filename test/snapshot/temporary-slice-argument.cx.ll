...
define i32 @main() #0 !dbg !4 {
  ...
  call void @_EN4main1fI3intEE5SliceI3intE(%"Slice<int>" %5), !dbg !7
  ...
  call void @_EN4main1fI3intEE5SliceI3intE(%"Slice<int>" %8), !dbg !8
  ret i32 0
}

define void @_EN4main1fI3intEE5SliceI3intE(%"Slice<int>" %a) #0 !dbg !9 {
  %a1 = alloca %"Slice<int>", align 8
  %s = alloca i32, align 4
  store %"Slice<int>" %a, ptr %a1, align 8
  %1 = call i32 @_EN3std5SliceI3intE4sizeE(ptr %a1), !dbg !10
  store i32 %1, ptr %s, align 4
  ret void
}

define i32 @_EN3std5SliceI3intE4sizeE(ptr %this) #0 !dbg !11 {
...
!9 = distinct !DISubprogram(name: "f", linkageName: "_EN4main1fI3intEE5SliceI3intE", scope: !3, file: !3, line: 3, type: !5, scopeLine: 3, spFlags: DISPFlagDefinition, unit: !2)
!10 = !DILocation(line: 4, column: 15, scope: !9)
!11 = distinct !DISubprogram(name: "size", linkageName: "_EN3std5SliceI3intE4sizeE", scope: !12, file: !12, line: 31, type: !5, scopeLine: 31, spFlags: DISPFlagDefinition, unit: !2)
