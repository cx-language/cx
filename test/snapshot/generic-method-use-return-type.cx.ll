...
define i32 @main() #0 !dbg !4 {
  ...
  %1 = call %"X<bool>" @_EN4main1XI5int32E1fI4boolEE4bool(ptr %x, i1 false), !dbg !7
  store %"X<bool>" %1, ptr %a, align 1
  call void @_EN4main1XI4boolE1gE(ptr %a), !dbg !8
  ret i32 0
}

define %"X<bool>" @_EN4main1XI5int32E1fI4boolEE4bool(ptr %this, i1 %u) #0 !dbg !9 {
...
!9 = distinct !DISubprogram(name: "f", linkageName: "_EN4main1XI5int32E1fI4boolEE4bool", scope: !3, file: !3, line: 4, type: !5, scopeLine: 4, spFlags: DISPFlagDefinition, unit: !2)
