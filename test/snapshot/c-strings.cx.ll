...
define i32 @main() #0 !dbg !4 {
  ...
  call void @_CX1N3stdM3std6string4initE4void2_PM3std4charM3std5int32(ptr %__str, ptr @0, i32 1), !dbg !7
  %__str.load = load %string, ptr %__str, align 8
  %2 = call i1 @_CX1N3stdo2eqEM3std4bool2_PM3std4charM3std6string(ptr %a, %string %__str.load), !dbg !8
  %a2 = getelementptr inbounds %S, ptr %s, i32 0, i32 0
  call void @_CX1N3stdM3std6string4initE4void2_PM3std4charM3std5int32(ptr %__str1, ptr @1, i32 1), !dbg !7
...
declare i1 @_CX1N3stdo2eqEM3std4bool2_PM3std4charM3std6string(ptr, %string) #0
