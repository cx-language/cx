...
@0 = private unnamed_addr constant [58 x i8] c"Unwrap failed at pointer-to-array-of-pointers.delta:8:21\0A\00", align 1
...
assert.fail:                                      ; preds = %0
  call void @_EN3std10assertFailEP4char(i8* getelementptr inbounds ([58 x i8], [58 x i8]* @0, i32 0, i32 0))
  unreachable
