...
define i32 @main() #0 !dbg !4 {
  %1 = call float @_EN4main1fI5floatEE5float(float 0.000000e+00), !dbg !7
  ret i32 0
}

define float @_EN4main1fI5floatEE5float(float %a) #0 !dbg !8 {
...
!8 = distinct !DISubprogram(name: "f", linkageName: "_EN4main1fI5floatEE5float", scope: !3, file: !3, line: 3, type: !5, scopeLine: 3, spFlags: DISPFlagDefinition, unit: !2)
