...
define void @_EN4main3fooER3Foo(ptr %ref_f) #0 !dbg !4 {
...
define i32 @main() #0 !dbg !7 {
  ...
  call void @_EN4main3fooER3Foo(ptr %f), !dbg !8
  ret i32 0
}
...
!4 = distinct !DISubprogram(name: "foo", linkageName: "_EN4main3fooER3Foo", scope: !3, file: !3, line: 5, type: !5, scopeLine: 5, spFlags: DISPFlagDefinition, unit: !2)
