...
define void @_CX1N4main3fooE4void0_() #0 !dbg !4 {
  ret void
}
...
define void @_CX1N4main2g2E4void1_F2_M3std5int32M3std4boolM3std5int32(ptr %p) #0 !dbg !10 {
  ...
  store ptr %p.load, ptr %p2, align 8
  %p2.load = load ptr, ptr %p2, align 8
  %1 = call i32 %p2.load(i32 42, i1 false), !dbg !11
  %2 = sext i32 %1 to i64
  %3 = add i64 %2, 1
...
define i32 @main() #0 !dbg !13 {
  ...
  store ptr @_CX1N4main3fooE4void0_, ptr %lf, align 8
  %lf.load = load ptr, ptr %lf, align 8
  call void @_CX1N4main1gE4void1_F0_4void(ptr %lf.load), !dbg !14
  store ptr @_CX1N4main2f2EM3std5int322_M3std5int32M3std4bool, ptr %lf2, align 8
  %lf2.load = load ptr, ptr %lf2, align 8
  call void @_CX1N4main2g2E4void1_F2_M3std5int32M3std4boolM3std5int32(ptr %lf2.load), !dbg !15
  ret i32 0
}
...
!3 = !DIFile(filename: "function-pointer-local-variable.cx")
!4 = distinct !DISubprogram(name: "foo", linkageName: "_CX1N4main3fooE4void0_", scope: !3, file: !3, line: 3, type: !5, scopeLine: 3, spFlags: DISPFlagDefinition, unit: !2)
...
!10 = distinct !DISubprogram(name: "g2", linkageName: "_CX1N4main2g2E4void1_F2_M3std5int32M3std4boolM3std5int32", scope: !3, file: !3, line: 12, type: !5, scopeLine: 12, spFlags: DISPFlagDefinition, unit: !2)
...
!14 = !DILocation(line: 19, column: 5, scope: !13)
!15 = !DILocation(line: 21, column: 5, scope: !13)
