...
define void @_EN4main1SI1RE1sE(ptr %this) #0 !dbg !10 {
  ...
  %1 = call %"A<R>" @_EN4main1AI1AI1REEixE3int(ptr %a, i32 0), !dbg !11
  store %"A<R>" %1, ptr %t, align 4
  %2 = call %R @_EN4main1AI1REixE3int(ptr %t, i32 0), !dbg !12
  store %R %2, ptr %tt, align 4
  %a1 = getelementptr inbounds %"S<R>", ptr %this, i32 0, i32 0
  %3 = call i32 @_EN4main1R1hE(ptr %tt), !dbg !13
  %4 = call %"A<R>" @_EN4main1AI1AI1REEixE3int(ptr %a1, i32 %3), !dbg !14
  ret void
}

define %"A<R>" @_EN4main1AI1AI1REEixE3int(ptr %this, i32 %i) #0 !dbg !15 {
...
define %R @_EN4main1AI1REixE3int(ptr %this, i32 %i) #0 !dbg !16 {
  %i1 = alloca i32, align 4
  store i32 %i, ptr %i1, align 4
...
!15 = distinct !DISubprogram(name: "[]", linkageName: "_EN4main1AI1AI1REEixE3int", scope: !3, file: !3, line: 22, type: !5, scopeLine: 22, spFlags: DISPFlagDefinition, unit: !2)
!16 = distinct !DISubprogram(name: "[]", linkageName: "_EN4main1AI1REixE3int", scope: !3, file: !3, line: 22, type: !5, scopeLine: 22, spFlags: DISPFlagDefinition, unit: !2)
