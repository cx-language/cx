...
define i1 @_EN4mainltEP1XP1X(ptr %a, ptr %b) #0 !dbg !4 {
...
define void @_EN4main2fxEP1XP1XP4voidP4void(ptr %a, ptr %b, ptr %v1, ptr %v2) #0 !dbg !7 {
  ...
  %3 = call i1 @_EN4mainltEP1XP1X(ptr %a.load7, ptr %b.load8), !dbg !8
...
!4 = distinct !DISubprogram(name: "<", linkageName: "_EN4mainltEP1XP1X", scope: !3, file: !3, line: 5, type: !5, scopeLine: 5, spFlags: DISPFlagDefinition, unit: !2)
