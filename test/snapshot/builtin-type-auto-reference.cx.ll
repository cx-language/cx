...
define void @_EN4main3fooEP3int(ptr %ref_i) #0 !dbg !4 {
...
define i32 @main() #0 !dbg !7 {
  ...
  call void @_EN4main3fooEP3int(ptr %bar), !dbg !8
  ret i32 0
}
...
!4 = distinct !DISubprogram(name: "foo", linkageName: "_EN4main3fooEP3int", scope: !3, file: !3, line: 3, type: !5, scopeLine: 3, spFlags: DISPFlagDefinition, unit: !2)
