...
define i32 @main() {
  ...
  call void @_EN4main1C4initE5SliceI3intE(ptr %1, %"Slice<int>" %5)
  call void @_EN4main1C3fooE(ptr %1)
  ret i32 0
}

define void @_EN4main1C4initE5SliceI3intE(ptr %this, %"Slice<int>" %a) {
...
define void @_EN4main1C3fooE(ptr %this) {
  ...
  %1 = call ptr @_EN3std5SliceI3intEixE3int(ptr %a, i32 4)
  ret void
}
