...
define i32 @main() #0 !dbg !4 {
  ...
  call void @_EN4main1C4initE8ArrayRefI3intE(ptr %1, %"ArrayRef<int>" %5), !dbg !7
  call void @_EN4main1C3fooE(ptr %1), !dbg !8
  ret i32 0
}

define void @_EN4main1C4initE8ArrayRefI3intE(ptr %this, %"ArrayRef<int>" %a) #0 !dbg !9 {
...
define void @_EN4main1C3fooE(ptr %this) #0 !dbg !10 {
  ...
  %1 = call ptr @_EN3std8ArrayRefI3intEixE3int(ptr %a, i32 4), !dbg !11
  ret void
}

define ptr @_EN3std8ArrayRefI3intEixE3int(ptr %this, i32 %index) #0 !dbg !12 {
...
or.rhs:                                           ; preds = %0
  ...
  %2 = call i32 @_EN3std8ArrayRefI3intE4sizeE(ptr %this), !dbg !14
...
if.then:                                          ; preds = %or.end
  ...
  call void @_EN3std8ArrayRefI3intE16indexOutOfBoundsE6string3int(ptr %this, %string %__str.load, i32 %index.load3), !dbg !16
  br label %if.end
...
define i32 @_EN3std8ArrayRefI3intE4sizeE(ptr %this) #0 !dbg !17 {
...
define void @_EN3std8ArrayRefI3intE16indexOutOfBoundsE6string3int(ptr %this, %string %function, i32 %index) #0 !dbg !18 {
  ...
  call void @_EN3std6string4initEP4char3int(ptr %__str, ptr @1, i32 9), !dbg !19
  ...
  %2 = call i32 @_EN3std8ArrayRefI3intE4sizeE(ptr %this), !dbg !20
  store i32 %2, ptr %1, align 4
  %3 = call %never @_EN3std5abortI6string6string6string3int6string3intEVEP6stringP6stringP6stringP3intP6stringP3int(ptr %__str, ptr %function1, ptr %__str3, ptr %index2, ptr %__str4, ptr %1), !dbg !21
  ret void
}
...
!9 = distinct !DISubprogram(name: "init", linkageName: "_EN4main1C4initE8ArrayRefI3intE", scope: !3, file: !3, line: 3, type: !5, scopeLine: 3, spFlags: DISPFlagDefinition, unit: !2)
...
!12 = distinct !DISubprogram(name: "[]", linkageName: "_EN3std8ArrayRefI3intEixE3int", scope: !13, file: !13, line: 42, type: !5, scopeLine: 42, spFlags: DISPFlagDefinition, unit: !2)
!13 = !DIFile(filename: "ArrayRef.cx")
!14 = !DILocation(line: 43, column: 34, scope: !12)
!15 = !DILocation(line: 42, column: 14, scope: !12)
!16 = !DILocation(line: 43, column: 41, scope: !12)
!17 = distinct !DISubprogram(name: "size", linkageName: "_EN3std8ArrayRefI3intE4sizeE", scope: !13, file: !13, line: 31, type: !5, scopeLine: 31, spFlags: DISPFlagDefinition, unit: !2)
!18 = distinct !DISubprogram(name: "indexOutOfBounds", linkageName: "_EN3std8ArrayRefI3intE16indexOutOfBoundsE6string3int", scope: !13, file: !13, line: 83, type: !5, scopeLine: 83, spFlags: DISPFlagDefinition, unit: !2)
!19 = !DILocation(line: 83, column: 18, scope: !18)
!20 = !DILocation(line: 84, column: 88, scope: !18)
