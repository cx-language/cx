...
define void @_EN3std5SliceI3intE16indexOutOfBoundsE6string3int(ptr %this, %string %function, i32 %index) #0 !dbg !18 {
  ...
  %1 = call i32 @_EN3std5SliceI3intE4sizeE(ptr %this), !dbg !20
  %2 = call %never @_EN3std5abortI6string6string6string3int6string3intEVE6string6string6string3int6string3int(%string %__str.load, %string %function.load, %string %__str.load5, i32 %index.load, %string %__str.load6, i32 %1), !dbg !21
  ret void
}

define %never @_EN3std5abortI6string6string6string3int6string3intEVE6string6string6string3int6string3int(%string %args_0, %string %args_1, %string %args_2, i32 %args_3, %string %args_4, i32 %args_5) #0 !dbg !22 {
  ...
  call void @_EN3std16OutputFileStream5writeI3intEER3int(ptr %4, ptr %arg9), !dbg !25
  ...
  call void @_EN3std16OutputFileStream5writeI3intEER3int(ptr %6, ptr %arg11), !dbg !25
...
!18 = distinct !DISubprogram(name: "indexOutOfBounds", linkageName: "_EN3std5SliceI3intE16indexOutOfBoundsE6string3int", scope: !13, file: !13, line: 115, type: !5, scopeLine: 115, spFlags: DISPFlagDefinition, unit: !2)
...
!22 = distinct !DISubprogram(name: "abort", linkageName: "_EN3std5abortI6string6string6string3int6string3intEVE6string6string6string3int6string3int", scope: !23, file: !23, line: 9, type: !5, scopeLine: 9, spFlags: DISPFlagDefinition, unit: !2)
