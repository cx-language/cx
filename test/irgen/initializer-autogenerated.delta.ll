...
define i32 @main() {
  ...
  call void @_EN4main7GenericI5floatE4initE1i5float(%"Generic<float>"* %g, float 4.500000e+00)
...
define void @_EN4main7GenericI5floatE4initE1i5float(%"Generic<float>"* %this, float %i) {
