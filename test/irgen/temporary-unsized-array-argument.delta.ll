...
define i32 @main() {
  ...
  call void @_EN4main1fI3intEEPAR_3int(%"ArrayRef<int>" %6)
  ...
  call void @_EN4main1fI3intEEPAR_3int(%"ArrayRef<int>" %9)
  ...
  call void @_EN4main1fI3intEEPAR_3int(%"ArrayRef<int>" %12)
  ret i32 0
}

define void @_EN4main1fI3intEEPAR_3int(%"ArrayRef<int>" %a) {
  %s = alloca i32
