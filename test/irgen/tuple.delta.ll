...
define { i1, { float } } @_EN4main1fE() {
  ...
  %b1.load = load { i1, { float } }, { i1, { float } }* %b1
  store { i1, { float } } %b1.load, { i1, { float } }* %b
  %d2 = getelementptr inbounds { i1, { float } }, { i1, { float } }* %b, i32 0, i32 1
  %e3 = getelementptr inbounds { float }, { float }* %d2, i32 0, i32 0
  %e3.load = load float, float* %e3
  store float %e3.load, float* %e
  ...
  %e7.load = load float, float* %e7
  store float %e7.load, float* %e
