...
define i1 @_EN3stdeqI3intEEPO3intPO3int(%"Optional<int>"* %a, %"Optional<int>"* %b) {
  ...
  %hasValue1.load = load i1, i1* %hasValue1
  %1 = icmp ne i1 %hasValue.load, %hasValue1.load
...
if.end:                                           ; preds = %if.else
  %hasValue2 = getelementptr inbounds %"Optional<int>", %"Optional<int>"* %b, i32 0, i32 0
  %hasValue2.load = load i1, i1* %hasValue2
  %2 = xor i1 %hasValue2.load, true
...
if.end5:                                          ; preds = %if.else4
  ...
  %value6 = getelementptr inbounds %"Optional<int>", %"Optional<int>"* %b, i32 0, i32 1
  %value6.load = load i32, i32* %value6
  %3 = icmp eq i32 %value.load, %value6.load
  ret i1 %3
}
...
if.end:                                           ; preds = %if.else, %assert.success
  ret void
