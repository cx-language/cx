...
define i32 @main() {
  ...
  call void @_EN4main1MI3intE4initE1aPAR_3int({}* %1, %"ArrayRef<int>" %4)
  ret i32 0
}
...
define void @_EN4main1MI3intE4initE1aPAR_3int({}* %this, %"ArrayRef<int>" %a) {
  ret void
}
