...
define i32 @main() {
  ...
  store %"RangeIterator<int>" %3, %"RangeIterator<int>"* %__iterator18
  br label %while

while:                                            ; preds = %body, %0
  %__iterator181 = load %"RangeIterator<int>", %"RangeIterator<int>"* %__iterator18
  %4 = call i1 @_EN3std13RangeIteratorI3intE8hasValueE(%"RangeIterator<int>" %__iterator181)
  br i1 %4, label %body, label %endwhile

body:                                             ; preds = %while
  %__iterator182 = load %"RangeIterator<int>", %"RangeIterator<int>"* %__iterator18
  %5 = call i32 @_EN3std13RangeIteratorI3intE5valueE(%"RangeIterator<int>" %__iterator182)
  store i32 %5, i32* %i
  %6 = load i32, i32* %p
  %i3 = load i32, i32* %i
  %7 = sub i32 %6, %i3
