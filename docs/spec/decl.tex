...
\begin{grammar}
\nonterminal{immutable-variable-declaration} \textrightarrow{} \code{let} \nonterminal{variable-name} \code{:} \nonterminal{type} \code{;}\\
\nonterminal{mutable-variable-declaration} \textrightarrow{} \code{var} \nonterminal{variable-name} \code{:} \nonterminal{type} \code{;}\\
\nonterminal{immutable-variable-definition} \textrightarrow{} \code{let} \nonterminal{variable-name} (\code{:} \nonterminal{type})\optional{} \code{=} \nonterminal{initializer} \code{;}\\
\nonterminal{mutable-variable-definition} \textrightarrow{} \code{var} \nonterminal{variable-name} (\code{:} \nonterminal{type})\optional{} \code{=} \nonterminal{initializer} \code{;}
\end{grammar}
...
\begin{grammar}
\nonterminal{initializer-definition} \textrightarrow{} \code{init} \code{(} \nonterminal{parameter-list} \code{)} \code{\{} \nonterminal{body} \code{\}}
\end{grammar}

Initializers can be invoked with the following syntax:

\begin{grammar}
\nonterminal{initializer-call} \textrightarrow{} \nonterminal{receiver-type} \code{(} \nonterminal{argument-list} \code{)}
\end{grammar}
...
\begin{grammar}
\nonterminal{deinitializer-definition} \textrightarrow{} \code{deinit} \code{(} \code{)} \code{\{} \nonterminal{body} \code{\}}
\end{grammar}
...
\begin{grammar}
\nonterminal{struct-definition} \textrightarrow{} \code{struct} \nonterminal{struct-name} \code{\{} \nonterminal{member-list} \code{\}}
\end{grammar}
...
\begin{grammar}
\nonterminal{generic-parameter} \textrightarrow{} \nonterminal{generic-type-parameter}\\
\nonterminal{generic-type-parameter} \textrightarrow{} \nonterminal{identifier}
\end{grammar}
