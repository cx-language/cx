...
\begin{grammar}
\rule{immutable-variable-declaration} \code{let} \nonterminal{variable-name} \code{:} \nonterminal{type} \code{;}\\
\rule{mutable-variable-declaration} \code{var} \nonterminal{variable-name} \code{:} \nonterminal{type} \code{;}\\
\rule{immutable-variable-definition} \code{let} \nonterminal{variable-name} (\code{:} \nonterminal{type})\optional{} \code{=} \nonterminal{initializer} \code{;}\\
\rule{mutable-variable-definition} \code{var} \nonterminal{variable-name} (\code{:} \nonterminal{type})\optional{} \code{=} \nonterminal{initializer} \code{;}
\end{grammar}
